...
const UsersPage = (props) => {
        ...
        <Grid>
          <Tooltip title='View User'>
            <IconButton
              ...
              onClick={() => props.history.push(`users/${row.original._id}`)}
            >
              <VisibilityIcon />
            </IconButton>
          </Tooltip>
          <Tooltip title='Edit User'>
            <IconButton
              ...
              onClick={() =>
                props.history.push(`users/${row.original._id}?edit=true`)
              }
            >
              <EditIcon />
            </IconButton>
  ...
  const deleteUser = (val) => {
    try {
      if (val !== null) {
        ...
        dispatch(Actions.userAction.DeleteUser(selectedIds))
          .then((response) => {
  ...
  React.useEffect(() => {
    dispatch(Actions.userAction.GetUserList())
      .then((response) => {
        //console.log("response", response);
      })
      .catch((error) => {
